            ...
            var projects = new List<Solution> {
                ...
                new Solution {
                    ...
                    ProjectFiles = new List<string> {
                        Path.Combine(path, "../CharpHat.Droid/CharpHat.Droid.csproj"),
                        Path.Combine(path, "../CharpHat.Shared/CharpHat.projitems")
                    },
                },
                ...
                new Solution {
                    Name = "iOS",
                    ProjectFiles = new List<string> {
                        Path.Combine(path, "../CharpHat.iOS/CharpHat.iOS.csproj"),
                        Path.Combine(path, "../CharpHat.Shared/CharpHat.projitems")
                    },
                },
            };
